...
export function Logo() {
  return (
    <SidebarMenuButton
      size="lg"
      className=" hover:bg-transparent gap-3 [&>svg]:size-auto"
    >
      <div className="flex size-8 items-center justify-center rounded-md overflow-hidden  text-sidebar-primary-foreground">
        <svg
          width="15"
          height="15"
          viewBox="0 0 15 15"
